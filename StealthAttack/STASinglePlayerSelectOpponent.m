...
//        [myScene.currStage cleanup];
        ...
        backButton = [[STAButton alloc] initWithSize:button_size Name:@"back_button" Alpha:0];
        ...
        startButton = [[STAButton alloc] initWithSize:button_size Name:@"start_button" Alpha:0];
